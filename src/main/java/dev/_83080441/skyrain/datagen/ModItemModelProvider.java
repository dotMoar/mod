...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.MONOLITH_HELMET);
        trimmedArmorItem(ModItems.MONOLITH_CHESTPLATE);
        trimmedArmorItem(ModItems.MONOLITH_LEGGINS);
        trimmedArmorItem(ModItems.MONOLITH_BOOTS);
    ...
    private void trimmedArmorItem(DeferredItem<ArmorItem> itemDeferredItem) {
        final String MOD_ID = SkyRain.MOD_ID; // Change this to your mod id
